		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="#" class="d-block">Naim Najmi</a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item"><a href="#" class="nav-link"> <i
								...
								<p>
									Supplier<i class="right fas fa-angle-left"></i>
								</p>
						</a>
							<ul class="nav  nav-treeview">
								...
								<li class="nav-item"><a href="SupplierAdd.jsp"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Supplier Add</p>
								</a></li>
							</ul></li>
							...
							<form action="/Megathlon/Supplier" method="post"
								...
								<div class="card-footer bg-white  ">
									<div class="d-flex justify-content-between">
										<div>
											<button onclick="window.location.href='homepage.jsp';"
